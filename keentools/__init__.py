...
bl_info = {
    "name": "KeenTools: FaceBuilder, FaceTracker, GeoTracker 2026.1.0",  # (1/6)
    "version": (2026, 1, 0),  # 2026.1.0 (2/6)
    "author": "KeenTools",
...
def _is_config_latest():
    return Config.addon_version_tuple == bl_info_copy['version']
...
if not _can_load():
    ...
    from .characterbuilder import register as characterbuilder_register
    from .characterbuilder import unregister as characterbuilder_unregister
    ...
    def register():
        ...
        characterbuilder_register()
        _log.info('CharacterBuilder classes have been registered')
        add_timeline_panel()
    ...
    def unregister():
        ...
        characterbuilder_unregister()
        _log.info('CharacterBuilder classes have been unregistered')
